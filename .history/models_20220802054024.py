...
class Show(db.Model):
    ...
    venue_id = db.Column(db.Integer, db.ForeignKey(Venue.id), nullable=, primary_key=True)
    artist_id = db.Column(db.Integer, db.ForeignKey(Artist.id), nullable=True, primary_key=True)
