...
def edit_venue(venue_id):
  ...
  print(type(form.state.data ))

  # print(form.state.default)

  venue = Venue.query.get(venue_id)
  
 
  form.state.data = form.state.choices[2] 
  form.process()
...
def edit_venue_submission(venue_id):
  ...
  try:
    ...
    venue.state =  request.args.get('state'),
    venue.address =  request.args.get('address')  ,
    venue.phone =  request.args.get('phone', None),
    venue.genres =  request.args.get('genres'),
    venue.facebook_link =  request.args.get('facebook_link', None),
    venue.image_link = request.args.get('image_link', None),
    venue.website =  request.args.get('website_link', None),
    venue.seeking_talent = seeking_talent,
    venue.seeking_description =  request.args.get('seeking_description', None)  
