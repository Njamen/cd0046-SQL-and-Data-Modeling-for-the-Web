...
class Venue(db.Model):
    ...
    show_venue = db.relationship('Shows', primaryjoin=id == Show.venue_id , backref='venue',  lazy=False)   
...
class Artist(db.Model):
    ...
    website =  db.Column(db.String(120))   
    seeking_description = db.Column(db.String(200), default = "" )  
    show_artist = db.relationship('Shows.artist_id', backref='artist',  primaryjoin=id == Show.artist_id , lazy=False)
