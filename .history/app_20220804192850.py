...
def edit_venue(venue_id):
  ...
  try:
    ...
    venue = Venue (
      ...
      Vphone =  request.form.get('phone', None),
      Vgenres =  request.form['genres'],
      Vfacebook_link =  request.form.get('facebook_link', None),
      Vimage_link = request.form.get('image_link', None),
      Vwebsite =  request.form.get('website_link', None),
      Vseeking_talent = seeking_talent,
      Vseeking_description =  request.form.get('seeking_description', None)
    )  
