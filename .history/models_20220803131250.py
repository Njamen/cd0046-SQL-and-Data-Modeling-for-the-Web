...
class Show(db.Model):
    ...
    artist = db.relationship("Order", backref=backref("order_products", cascade="all, delete-orphan" ))
    product = db.relationship("Product", backref=backref("order_products", cascade="all, delete-orphan" ))
