...
def edit_venue(venue_id):
  ...
  try:
    ...
    venue = Venue (
      ...
      venuephone =  request.form.get('phone', None),
      venuegenres =  request.form['genres'],
      venuefacebook_link =  request.form.get('facebook_link', None),
      venueimage_link = request.form.get('image_link', None),
      venuewebsite =  request.form.get('website_link', None),
      venueseeking_talent = seeking_talent,
      venueseeking_description =  request.form.get('seeking_description', None)
    )  
