...
def venues():
  ...
  all_Venue = Venue.query.group_by(Venue.city).all()  #.filter(person.name=="Nicanora") 
  print(all_Venue) 

  all_Venue = Artist.query.with_entities(Artist.id, Artist.name).all()  #.filter(person.name=="Nicanora") 
