...
class Artist(db.Model):
    ...
    website =  db.Column(db.String(120))   
    seeking_description = db.Column(db.String(200), default = "" )  
    shows_artist = db.relationship('Shows', backref='artist', lazy=False, uselist = False)    #, backref='list'
...
Show = db.Table('shows',
    ...
    db.Column('artist_id', db.Integer, db.ForeignKey('product.id'), primary_key=True)
)
