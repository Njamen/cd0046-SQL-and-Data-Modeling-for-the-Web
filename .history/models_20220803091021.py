...
class Venue(db.Model):
    ...
    show_venue = db.relationship('Shows.artist_id', backref='Shows',  lazy=False)

    # shows_venue = db.relationship('Shows', backref='Venue', lazy=False, uselist = False)    #, backref='list'
...
class Show(Base):
    ...
    start_time = db.Column('start_time', db.DateTime(timezone=True) , primary_key=True)  
...
class Artist(db.Model):
    ...
    website =  db.Column(db.String(120))   
    seeking_description = db.Column(db.String(200), default = "" )  
    show_artist = db.relationship('Shows.artist_id', backref='Shows',  lazy=False)
...
#     artist = db.relationship(Artist,  lazy=False, uselist = False) 
#     Venue = db.relationship(Venue,  lazy=False, uselist = False)
